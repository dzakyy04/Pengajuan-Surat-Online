...
<aside id="sidebar"
    ...
    <nav class="flex-1 overflow-y-auto px-4 scrollbar-hide">
        ...
        <a href="{{ route('admin.dashboard') }}"
            class="flex items-center px-3 py-2.5 mb-1 rounded-lg hover:bg-gray-50 transition-colors duration-200 group {{ $isDashboardActive ? 'bg-emerald-50 text-emerald-600 font-semibold' : 'text-gray-700' }}">
            ...
            <span class="font-medium text-sm sidebar-text {{ $isDashboardActive ? 'font-semibold' : '' }}">Dashboard</span>
        </a>
        ...
        <div class="mb-1">
            <button type="button" onclick="toggleSubSidebar('kelolaSuratSub')"
                ...
                <svg id="kelolaSuratSubIcon"
                    class="w-4 h-4 transition-transform duration-200 {{ $isSubSidebarOpen ? 'rotate-180' : '' }}"
                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
