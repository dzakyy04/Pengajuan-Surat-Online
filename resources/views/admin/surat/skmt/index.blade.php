        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-3xl font-bold">{{ $submittedSkmt }}</h3>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-3xl font-bold">{{ $verifiedSkmt }}</h3>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-3xl font-bold">{{ $approvedSkmt }}</h3>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-3xl font-bold">{{ $notifiedSkmt }}</h3>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-3xl font-bold">{{ $rejectedSkmt }}</h3>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        function openUploadModal(id) {
            ...
            document.getElementById('uploadForm').action = `/admin/skmt/${id}/upload-ttd`;
        ...
        function openEmailModal(id, email, name) {
            ...
            document.getElementById('emailForm').action = `/admin/skmt/${id}/send-notification`;
