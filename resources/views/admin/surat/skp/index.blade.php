                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <div class="py-1">
                                ...
                                <a href="{{ route('admin.skp.index', ['status' => 'submitted']) }}"
                                ...
                                <a href="{{ route('admin.skp.index', ['status' => 'verified']) }}"
                                ...
                                <a href="{{ route('admin.skp.index', ['status' => 'approved']) }}"
                                    ...
                                    Disetujui
                                    <a href="{{ route('admin.skp.index', ['status' => 'rejected']) }}"
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-2">{{ $submittedSkp }}</h3>
                    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-2">{{ $verifiedSkp }}</h3>
                    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-2">{{ $approvedSkp }}</h3>
                    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-2">{{ $rejectedSkp }}</h3>
                    </div>
