                ...
                <div class="flex gap-2 items-center flex-wrap">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <form method="GET" action="{{ route('admin.sku.index') }}" class="p-4">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex gap-2 pt-2">
                                        ...
                                        <a href="{{ route('admin.sku.index', ['status' => request()->get('status')]) }}"
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <div class="py-1">
                                <a href="{{ route('admin.sku.index', array_filter(['start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
                                ...
                                <a href="{{ route('admin.sku.index', array_filter(['status' => 'submitted', 'start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
                                ...
                                <a href="{{ route('admin.sku.index', array_filter(['status' => 'verified', 'start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
                                ...
                                <a href="{{ route('admin.sku.index', array_filter(['status' => 'approved', 'start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
                                ...
                                <a href="{{ route('admin.sku.index', array_filter(['status' => 'notified', 'start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
                                ...
                                <a href="{{ route('admin.sku.index', array_filter(['status' => 'rejected', 'start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-3xl font-bold">{{ $submittedSku }}</h3>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-3xl font-bold">{{ $verifiedSku }}</h3>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-3xl font-bold">{{ $approvedSku }}</h3>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-3xl font-bold">{{ $notifiedSku }}</h3>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-3xl font-bold">{{ $rejectedSku }}</h3>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        function openEmailModal(id, email, name) {
            ...
            document.getElementById('emailForm').action = `/admin/sku/${id}/send-notification`;
