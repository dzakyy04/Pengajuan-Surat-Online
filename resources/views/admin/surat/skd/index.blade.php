                ...
                <div class="flex gap-2 items-center flex-wrap">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <form method="GET" action="{{ route('admin.skd.index') }}" class="p-4">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex gap-2 pt-2">
                                        ...
                                        <a href="{{ route('admin.skd.index', ['status' => request()->get('status')]) }}"
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <div class="py-1">
                                <a href="{{ route('admin.skd.index', array_filter(['start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
                                ...
                                <a href="{{ route('admin.skd.index', array_filter(['status' => 'submitted', 'start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
                                ...
                                <a href="{{ route('admin.skd.index', array_filter(['status' => 'verified', 'start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
                                ...
                                <a href="{{ route('admin.skd.index', array_filter(['status' => 'approved', 'start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
                                ...
                                <a href="{{ route('admin.skd.index', array_filter(['status' => 'notified', 'start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
                                ...
                                <a href="{{ route('admin.skd.index', array_filter(['status' => 'rejected', 'start_date' => request()->get('start_date'), 'end_date' => request()->get('end_date')])) }}"
