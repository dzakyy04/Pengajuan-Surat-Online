            ...
            <div
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Masukkan nama sesuai KTP"
                            class="w-full px-4 py-3 border @error('name') border-red-500 @else border-gray-300 @enderror rounded-lg focus:outline-none focus:ring-2 @error('name') focus:ring-red-500 @else focus:ring-emerald-500 @enderror focus:border-transparent transition"
                            required>
                        @error('name')
                ...
                <div class="mt-4 text-center">
                    <a href="{{ 'beranda' }}" class="text-gray-500 hover:text-gray-700 text-sm">
                        ← Kembali ke Beranda
                    </a>
                </div>
            </div>
